      ...
      <Routes>
        <Route
          ...
          element={
            <EmailVerification
              paths={paths}
              getPathDataById={getPathDataById}
            />
          }
        />
        <Route
          path="/auth-bank"
          element={
            <BankVerification paths={paths} getPathDataById={getPathDataById} />
          }
        />
        <Route
          path="/auth-id"
          element={
            <IdVerification paths={paths} getPathDataById={getPathDataById} />
          }
        />
        <Route
          path="/auth-buss"
          element={
            <BusinessRegNum paths={paths} getPathDataById={getPathDataById} />
          }
        />
      </Routes>
    </>
