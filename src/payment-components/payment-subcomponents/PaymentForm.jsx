    ...
    <>
      ...
      >
        ...
        >
          ...
          <Text textAlign="center" fontSize="xs" color="#333333">
          ...
          <Flex justify="center" gap={4} wrap="wrap">
            {paymentMethods.map((logo, index) => (
              <Button
                ...
                borderWidth="2px"
                borderColor={
                  selectedPayment === logo.name ? "blue.500" : "gray.200"
                }
                boxShadow="sm"
          ...
          >
            <Flex align="center" gap={2}>
              {`Pay ${selectedCurrency?.currencyCode || ""} ${
                amountValue || "0.00"
              }`}
