...
const CreatePaymentLink = ({ step, setStep }) => {
  ...
  const uploadWidth = useBreakpointValue({
    base: "100%",
    md: "90%",
    lg: "649px",
  });
  const uploadHeight = useBreakpointValue({
    base: "300px",
    md: "350px",
    lg: "444px",
  });
  ...
  const uploadMargin = useBreakpointValue({
    base: "20px",
    md: "40px",
    lg: "200px",
  });
        ...
        >
            ...
            <VStack spacing={6} align="stretch">
              ...
              <Box>
                ...
                <Textarea
                  ...
                  rows={6}
                />
                <Text fontSize="12px" color="#919191" textAlign="right">
                  0 / 280
                </Text>
              </Box>
                ...
                <Flex gap={2}>
                  ...
                  >
                    ...
                    <SelectContent bg="white" color="#575757">
                      <SelectItem item="NGN">NGN</SelectItem>
                      <SelectItem item="USD">USD</SelectItem>
                      <SelectItem item="EUR">EUR</SelectItem>
                      <SelectItem item="GBP">GBP</SelectItem>
                    </SelectContent>
                  </SelectRoot>
                  <Input
                    placeholder="0.00"
              ...
              <Box>
                ...
                <Flex gap={2}>
                  ...
                  >
                    ...
                    <SelectContent bg="white" color="#575757">
                      <SelectItem item="+234">+234</SelectItem>
                      <SelectItem item="+1">+1</SelectItem>
                      <SelectItem item="+44">+44</SelectItem>
                    </SelectContent>
                  </SelectRoot>
                  <Input
          ...
          >
            ...
            <Text
              ...
              mt={3}
            >
              This image will be displayed on social platforms where the link is
              shared
            </Text>
          </Box>
        </Stack>
