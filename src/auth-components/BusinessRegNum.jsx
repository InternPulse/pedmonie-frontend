 ...
 >
   ...
   >
     ...
     <Flex flex={1} direction="column" align="center" justify="center" bgColor="gray.200" h="full" p={6}>
         ...
         pt={4}
         pb={4}
         >{bussVerIndex} of {paths.length} - Business Registration Number</Text>
             ...
             <Flex flexDir={{base: "row", lg: "column"}} justify="center"  >
                 ...
                 <Flex flexDir={"column"} justify={"center"} align={"center"} gapY={8}>          
                     ...
                     <Flex direction="column">         
                      <Text as="h1" fontSize={{base:"sm", lg: "md"}} color="gray.800" textAlign={{base: "center", lg: "left"}} fontWeight="bold" pb={4}>Input your CAC Number to help us verify your company status</Text>  
                ...
                <Field.Root>
                    ...
                    <Field.Label css={floatingStyles}>
                        <Text fontSize={{base: "xs", lg: "sm"}}>Enter your CAC Number correctly</Text>
                    </Field.Label>
                    </Box>
                </Field.Root>
                </Box>
