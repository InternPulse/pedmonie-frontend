...
export default function App() {
  return (
    <Box bg="gray.50">
      ...
      {/* Contact Section */}
      <Box bg="#2E5C38" color="white" py={6} px={4} textAlign="center" mt={10} height={200}>
        <Flex align="center" justify="center" direction={{ base: "column", md: "row" }} gap={40}>
          <Image
