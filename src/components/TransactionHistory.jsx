...
import { Box, Flex, Text, HStack, Button, IconButton } from "@chakra-ui/react";
...
const TransactionHistory = () => {
  ...
  const renderPaginationButtons = () => {
    ...
    let startPage = Math.max(
      2,
      safeCurrentPage - Math.floor(maxButtonsToShow / 2)
    );
